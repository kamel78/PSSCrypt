use crate::aes_ciphers::aes::AES128;

pub struct AesCcm { aes: AES128 }
...
impl AesCcm {
    ...
    fn process_aad_fast(&self, mut mac_state: u128, aad: &[u8]) -> u128 {
        ...
        let padded_len = (total_len + 15) & !15; // Round up to 16-byte boundary        
        ...
        // Copy AAD (already zero-padded from vec allocation)
